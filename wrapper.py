...
if __name__ == "__main__":
    ...
    for i, gpu_id in enumerate(gpu_ids):
        ...
        command = f"CUDA_VISIBLE_DEVICES={gpu_id} python main.py --model {args.model} --data_path {args.data_path} --instruction_column {args.instruction_column} --start {start} --offset {offset} --mission {args.mission} --output_dir {args.output_dir}"
