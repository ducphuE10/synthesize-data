...
def document_quality_filtering(input):
    user_message = f'''
# Instruction

Does the following document have a good quality?
...
## Output Format
Given the document, you need to determine whether the document has good quality or not.
First give the explanation for your decision, highlighting the strengths and/or weaknesses of the document.
Then, rate the quality of the document as `good` or `bad` or `average` by filling in the placeholders in []:
```
{{   
    "explanation": "[...]",
    "document_quality": "[good/bad/average]"
}}
'''
    return user_message